# `catalog_postgres` — Postgres catalog (BYO-RDS)

**Status: scaffold (not yet implemented).** Optional — AFS_CATALOG=postgres.

Alternative catalog wiring: DSN secret + IAM grant + env wiring. Creates no database — bring your own RDS/Aurora.
