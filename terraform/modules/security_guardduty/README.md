# `security_guardduty` — GuardDuty malware scan (optional)

**Status: scaffold (not yet implemented).** Optional — enable_guardduty_scan.

GuardDuty S3 malware-protection plan, scan-result EventBridge rule, and the quarantine tagging/deny policy.
