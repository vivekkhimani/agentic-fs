# `auth_cognito` — Cognito IdP (optional)

**Status: scaffold (not yet implemented).** Optional — enable_cognito (default on).

Batteries-included OAuth: user pool, domain, resource server + scopes, and clients — exposed as issuer/audience outputs. Free under the free tier.
